...
#   ./demo.sh mini-chain-move1-move2 Run chained calc where second-stage MOVE02 selects the short output
#   ./demo.sh mini-chain-move1-revr2 Run chained calc where second-stage REVR02 selects the short output
...
#   ./demo.sh mini-chain-move2f6-6 Run chained calc where field 2 drives the 6-byte output
...
CHAIN_MOVE1_MOVE2_DEMO_SRC="tiny_rpg_demo_chain_move1_move2.src"
CHAIN_MOVE1_REVR2_DEMO_SRC="tiny_rpg_demo_chain_move1_revr2.src"
CHAIN_MOVE2_REVR1_DEMO_SRC="tiny_rpg_demo_chain_move2_revr1.src"
CHAIN_REVR0_6_DEMO_SRC="tiny_rpg_demo_chain_revr0_6.src"
CHAIN_MOVE2F6_6_DEMO_SRC="tiny_rpg_demo_chain_move2f6_6.src"
prepare_demo() {
...
case "${1:-demo}" in
    ...
    mini)
        ...
        echo "Chained MOVE01+MOVE02 tiny demo source: $CHAIN_MOVE1_MOVE2_DEMO_SRC"
        echo "Chained MOVE01+REVR02 tiny demo source: $CHAIN_MOVE1_REVR2_DEMO_SRC"
        ...
        echo "Chained field2+6-byte tiny demo source: $CHAIN_MOVE2F6_6_DEMO_SRC"
        ...
        echo "Try: ./demo.sh mini-chain-move1-move2"
        echo "Try: ./demo.sh mini-chain-move1-revr2"
        echo "Try: ./demo.sh mini-chain-move2-revr1"
        echo "Try: ./demo.sh mini-chain-revr0-6"
        echo "Try: ./demo.sh mini-chain-move2f6-6"
        echo "Generated source: $RPG2_GEN"
        ;;
    mini-tail3)
    ...
    mini-rev3)
        ...
        ;;
    mini-revr-gateoff)
        prepare_demo "$REVR_GATEOFF_DEMO_SRC"
        echo "=== sw-cor24-rpg-ii Minimal RPG-II Demo (Reverse + Gate-Off Variant) ==="
        echo "Program:"
        echo "H  control header"
        echo "F  input file INFIL"
        echo "I  field 01: A0110  (10-char input slice)"
        ...
        echo "O  DETAIL01 output (10 chars) gated when indicator 01 is off"
        echo "O  DETAIL02 output (3 chars)"
        echo ""
        echo "Current boundary:"
        echo "- Real today: output gating now supports two tiny parsed conditions:"
        echo "  gate 01 requires indicator 01 on, and gate 02 requires indicator 01 off."
        echo "- This variant composes REVR01 with gate 02, so the reversed 10-byte field"
        echo "  emits only because REVR01 leaves indicator 01 cleared."
        echo ""
        echo "Current runtime-produced output:"
        print_runtime_output_or_placeholder "$REVR_GATEOFF_DEMO_SRC"
        echo ""
        echo "Authored source: rpg2.hlasm"
    ...
    mini-revr6)
        ...
        ;;
    mini-chain)
        prepare_demo "$CHAIN_DEMO_SRC"
        echo "=== sw-cor24-rpg-ii Minimal RPG-II Demo (Two-Calc Chain Variant) ==="
        echo "Program:"
        echo "H  control header"
        echo "F  input file INFIL"
        echo "I  field 01: A0110  (10-char input slice)"
        echo "I  field 02: A0810  (3-char input tail slice)"
        echo "C  MOVE01 -> calc stage 0"
        echo "C  REVR00 -> calc stage 1 over the current calc result"
        echo "O  DETAIL01 output (10 chars)"
        echo "O  DETAIL02 output (3 chars)"
        echo ""
        echo "Current boundary:"
        echo "- Real today: the tiny parsed C-spec subset can now carry a second calc slot,"
        echo "  and slot 1 can transform the current calc result via source selector 00."
        echo "- This variant chains MOVE01 into REVR00, so the second calc stage reverses"
        echo "  the first stage output before formatting the detail line."
        echo ""
        echo "Current runtime-produced output:"
        print_runtime_output_or_placeholder "$CHAIN_DEMO_SRC"
        echo ""
        echo "Authored source: rpg2.hlasm"
        echo "Tiny demo source: $CHAIN_DEMO_SRC"
        echo "Generated source: $RPG2_GEN"
        ;;
    mini-chain-move1-6)
        prepare_demo "$CHAIN_MOVE1_6_DEMO_SRC"
        echo "=== sw-cor24-rpg-ii Minimal RPG-II Demo (Chain Reselect + 6-Byte Output) ==="
        echo "Program:"
        echo "H  control header"
        echo "F  input file INFIL"
        echo "I  field 01: A0110  (10-char input slice)"
        ...
        echo "C  MOVE01 -> calc stage 1 reselects raw field 01"
        echo "O  DETAIL01 output (10 chars)"
        echo "O  DETAIL02 output (3 chars)"
        echo "O  DETAIL03 output (6 chars)"
        echo ""
        echo "Current boundary:"
        echo "- Real today: calc slot 1 can now use source selector 01 or 02, so a chained"
        echo "  program can replace the first calc result with a freshly selected raw field."
        echo "- This variant uses REVR01 only to select DETAIL03, then MOVE01 overrides the"
        echo "  calc result so the emitted 6-byte line is the raw field-01 prefix."
        echo ""
        echo "Current runtime-produced output:"
        print_runtime_output_or_placeholder "$CHAIN_MOVE1_6_DEMO_SRC"
        echo ""
        echo "Authored source: rpg2.hlasm"
        echo "Tiny demo source: $CHAIN_MOVE1_6_DEMO_SRC"
        echo "Generated source: $RPG2_GEN"
        ;;
    mini-chain-move1-move2)
        prepare_demo "$CHAIN_MOVE1_MOVE2_DEMO_SRC"
        echo "=== sw-cor24-rpg-ii Minimal RPG-II Demo (Chain MOVE01 + MOVE02) ==="
        echo "Program:"
        echo "H  control header"
        echo "F  input file INFIL"
        echo "I  field 01: A0110  (10-char input slice)"
        echo "I  field 02: A0810  (3-char input tail slice)"
        echo "C  MOVE01 -> calc stage 0"
        echo "C  MOVE02 -> calc stage 1 reselects field 02"
        echo "O  DETAIL01 output (10 chars)"
        echo "O  DETAIL02 output (3 chars)"
        echo ""
        echo "Current boundary:"
        echo "- Real today: when calc slot 1 is a parsed MOVE over field 01 or 02, the"
        echo "  runtime now lets that decoded metadata pick the matching two-output detail"
        echo "  definition instead of leaving short-vs-long output selection hard-wired to"
        echo "  calc slot 0."
        echo "- Placeholder today: this is still only the current tiny MOVE/REVR subset,"
        echo "  not a general multi-step C-spec executor or general O-spec selector."
        echo ""
        echo "Current runtime-produced output:"
        print_runtime_output_or_placeholder "$CHAIN_MOVE1_MOVE2_DEMO_SRC"
        echo ""
        echo "Authored source: rpg2.hlasm"
        echo "Tiny demo source: $CHAIN_MOVE1_MOVE2_DEMO_SRC"
        echo "Generated source: $RPG2_GEN"
        ;;
    mini-chain-move1-revr2)
        prepare_demo "$CHAIN_MOVE1_REVR2_DEMO_SRC"
        echo "=== sw-cor24-rpg-ii Minimal RPG-II Demo (Chain MOVE01 + REVR02) ==="
        echo "Program:"
        echo "H  control header"
        echo "F  input file INFIL"
        echo "I  field 01: A0110  (10-char input slice)"
        echo "I  field 02: A0810  (3-char input tail slice)"
        echo "C  MOVE01 -> calc stage 0"
        echo "C  REVR02 -> calc stage 1 reverses field 02"
        echo "O  DETAIL01 output (10 chars)"
        echo "O  DETAIL02 output (3 chars)"
        echo ""
        echo "Current boundary:"
        echo "- Real today: when calc slot 1 is a parsed REVR over field 01 or 02, the"
        echo "  runtime now lets that decoded metadata pick the matching two-output detail"
        echo "  definition instead of leaving short-vs-long output selection fixed to"
        echo "  calc slot 0."
        echo "- Placeholder today: this is still only the current tiny MOVE/REVR subset,"
        echo "  not a general multi-step C-spec executor or general O-spec selector."
        echo ""
        echo "Current runtime-produced output:"
        print_runtime_output_or_placeholder "$CHAIN_MOVE1_REVR2_DEMO_SRC"
        echo ""
        echo "Authored source: rpg2.hlasm"
        echo "Tiny demo source: $CHAIN_MOVE1_REVR2_DEMO_SRC"
        echo "Generated source: $RPG2_GEN"
        ;;
    mini-chain-move2-revr1)
        prepare_demo "$CHAIN_MOVE2_REVR1_DEMO_SRC"
        echo "=== sw-cor24-rpg-ii Minimal RPG-II Demo (Chain Reverse Field Override) ==="
        echo "Program:"
        echo "H  control header"
        echo "F  input file INFIL"
        echo "I  field 01: A0110  (10-char input slice)"
        echo "I  field 02: A0810  (3-char input tail slice)"
        echo "C  MOVE02 -> calc stage 0"
        echo "C  REVR01 -> calc stage 1 overrides with reversed field 01"
        echo "O  DETAIL01 output (10 chars)"
        echo "O  DETAIL02 output (3 chars)"
        echo ""
        echo "Current boundary:"
        echo "- Real today: calc slot 1 can now use REVR01 or REVR02, reusing the raw-field"
        echo "  reverse helpers and, in the two-output subset, also taking over matching"
        echo "  output-definition selection from calc slot 0."
        echo "- This variant starts with MOVE02, then REVR01 overrides both the calc result"
        echo "  and the selected detail shape, so the reversed 10-byte field 01 is emitted."
        echo ""
        echo "Current runtime-produced output:"
        print_runtime_output_or_placeholder "$CHAIN_MOVE2_REVR1_DEMO_SRC"
        echo ""
        echo "Authored source: rpg2.hlasm"
    ...
    mini-chain-revr0-6)
        ...
        echo "Generated source: $RPG2_GEN"
        ;;
    mini-chain-move2f6-6)
        prepare_demo "$CHAIN_MOVE2F6_6_DEMO_SRC"
        echo "=== sw-cor24-rpg-ii Minimal RPG-II Demo (Chain Field-2 Third Shape) ==="
        echo "Program:"
        echo "H  control header"
        echo "F  input file INFIL"
        echo "I  field 01: A0110  (10-char input slice)"
        echo "I  field 02: A0510  (6-char mid-record slice)"
        echo "C  REVR01 -> calc stage 0"
        echo "C  MOVE02 -> calc stage 1 reselects field 02"
        echo "O  DETAIL01 output (10 chars)"
        echo "O  DETAIL02 output (3 chars)"
        ...
        echo ""
        echo "Current boundary:"
        echo "- Real today: stage 0 can still drive the third output-shape selection while"
        echo "  calc slot 1 replaces the visible result with a different decoded field."
        echo "- This variant uses field 02 as a 6-byte slice, so DETAIL03 emits RD 01A-"
        echo "  style prefixes instead of the field-01 prefix used by earlier 6-byte demos."
        echo ""
        echo "Current runtime-produced output:"
        print_runtime_output_or_placeholder "$CHAIN_MOVE2F6_6_DEMO_SRC"
        echo ""
        echo "Authored source: rpg2.hlasm"
        echo "Tiny demo source: $CHAIN_MOVE2F6_6_DEMO_SRC"
        echo "Generated source: $RPG2_GEN"
        ;;
    *)
        echo "Usage: $0 [demo|mini|mini-tail3|mini-gateoff|mini-rev3|mini-revr-gateoff|mini-revr6|mini-chain|mini-chain-move1-6|mini-chain-move1-move2|mini-chain-move1-revr2|mini-chain-move2-revr1|mini-chain-revr0-6|mini-chain-move2f6-6|test|repl]"
        exit 1
        ;;
esac
